<x-app-layout>
    <div class="mx-auto max-w-screen-2xl p-4 md:p-6 2xl:p-10">
        ...
        >
          <!-- ====== Chart One Start -->
          @include('backend.partials.chart-01')
          <!-- ====== Chart One End -->

          <!-- ====== Chart Two Start -->
          @include('backend.partials.chart-02')
          <!-- ====== Chart Two End -->

          <!-- ====== Chart Three Start -->
          @include('backend.partials.chart-03')
          <!-- ====== Chart Three End -->

          <!-- ====== Map One Start -->
         @include('backend.partials.map-01')
          <!-- ====== Map One End -->

          <!-- ====== Table One Start -->
          <div class="col-span-12 xl:col-span-8">
           @include('backend.partials.table-01')
          </div>
          <!-- ====== Table One End -->
